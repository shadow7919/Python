...
and you have two data type for number integer and long 

Also with big numbers you can sep the with _ like 1_000_000
It's more readable 
...
all any --> two built ins
all ==  return true if all element are true
any ==  return true if any element are true , or not empty
"""
